...
import 'pages/map_page.dart'; // ✅ Harita sayfası eklendi
...
void main() async {
  ...
  // Firebase'i geçici olarak devre dışı bırak
  try {
...
class FitTakipApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        '/map': (context) => const MapPage(), // ✅ Harita rotası tanımı
      },
      home: const MainScreen(), // Firebase Auth'u geçici olarak devre dışı bırak
    );
  }
}
